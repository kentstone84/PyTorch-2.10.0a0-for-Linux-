#!/bin/bash
# ========================================================================
# Native Triton Build Script for SM 12.0 (Blackwell) - Python 3.14
# ========================================================================
# This script builds Triton natively with CUDA 13.0 PTXAS for SM 12.0 support
# Produces: triton-*-cp314-cp314-linux_x86_64.whl
# ========================================================================

set -e

echo "========================================================================"
echo "Triton Native Build Script for SM 12.0 (Blackwell) - Python 3.14"
echo "========================================================================"
echo ""
...
# Configuration
# -------------------------------------------------------------------------
BUILD_DIR="$HOME/triton-build-sm120-py314"
...
if ! command -v python3.14 &> /dev/null; then
    ...
    echo "Python 3.14 is not yet released. Install from source or wait for official release."
    echo ""
    echo "For development builds:"
    echo "  git clone https://github.com/python/cpython"
    echo "  cd cpython && git checkout 3.14"
...
PYTHON_VERSION=$(python3.14 --version | awk '{print $2}')
...
# -------------------------------------------------------------------------
echo ""
echo "[5/6] Building Triton with Python 3.14..."
...
python3.14 -m venv "$BUILD_DIR/venv"
...
if [ ! -f "$WHEEL_FILE" ]; then
    ...
    echo "Expected: dist/triton-*cp314*.whl"
    ls -la dist/
    exit 1
fi

WHEEL_NAME="triton_sm120_cp314.whl"
...
echo ""
echo "To verify:"
echo "  python3.14 -c 'import triton; print(triton.__version__)'"
echo ""
echo "========================================================================"
